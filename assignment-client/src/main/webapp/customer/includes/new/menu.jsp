<%-- 
    Document   : menu
    Created on : Aug 12, 2022, 4:41:18 PM
    Author     : thilan
--%>
...
<!--            <div class="dropdown d-inline-block">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="/assignment-client/customer/view/profile/update.jsp"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">Profile</span></a>
