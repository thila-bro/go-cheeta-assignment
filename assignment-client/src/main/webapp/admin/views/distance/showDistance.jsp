<%-- 
    Document   : showDistance
    Created on : 16 Aug 2022, 17:21:43
...
<% City sourceCity = admin_proxy.getCityById(Integer.parseInt(request.getParameter("id"))); %>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Distance from <% out.print(sourceCity.getName()); %></h4>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tbody>
                                                <% List<City> cities = admin_proxy.getCitiesWithOutSelectedId(Integer.parseInt(request.getParameter("id"))); %>
                                                <% for(City city: cities){ %>
                                                <% Distance distance = admin_proxy.getDistanceBySourceIdAndDestinationId(Integer.parseInt(request.getParameter("id")), city.getCityId()); %>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="./updateDistance.jsp?source_city=<% out.print(city.getCityId()); %>&destination_city=<% out.print(Integer.parseInt(request.getParameter("id"))); %>" class="btn btn-sm btn-warning"><i class="mdi mdi-file-document-edit-outline align-middle me-1"></i>Update</a>
                                                    </td>
                                                </tr>
                                                <% } %>
                                            </tbody>
