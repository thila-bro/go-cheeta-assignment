<%-- 
    Document   : alla
    Created on : 16 Sept 2022, 11:31:24
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All Email Template</h4>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tbody>
                                                <% List<Template> templates = admin_proxy.getEmailTemplates(); %>
                                                <% for(Template template: templates){ %>
                                                <tr>
                                                    <td><% out.print(templates.indexOf(template)+1); %></td>
                                                    <td><% out.print(template.getTitle()); %></td>
                                                    <td>
                                                        <a href="./edit.jsp?id=<% out.print(template.getTemplateId()); %>" class="btn btn-sm btn-warning"><i class="mdi mdi-file-document-edit-outline align-middle me-1"></i>Edit</a>
                                                        <a href="./edit.jsp?id=<% out.print(template.getTemplateId()); %>" class="btn btn-sm btn-primary"><i class="mdi mdi-file-document-edit-outline align-middle me-1"></i>Preview</a>
                                                    </td>
                                                </tr>
                                                <% } %>
                                            </tbody>
